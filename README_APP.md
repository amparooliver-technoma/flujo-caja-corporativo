...
- La columna `Moneda` se detecta desde el resumen/total de `PClientes`: si el total tiene punto y coma se toma como `USD`; si usa separadores de miles sin decimal o indica `Gs.`, se toma como `GS`.
